...
***There are `r nrow(Whickham)`observations in this dataset. Each observation represents one particular women in the study.***
...
***I expect smoker will more likely to be dead*** 
...
***The relationship between smoking status and health outcome did not meet what I had thought would happen. Those who had smoked have a higher probability of being alive 20 years later.*** 
...
***The plot shows that smokers have a higher probability of being dead in each age category***
